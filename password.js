	...
	new Promise((resolve, reject) => {
		...
		.then(user => {
			...
			const transporter = nodemailer.createTransport({
			  ...
			  Connection: true,
			  auth: {
               user: 'surajjunni52@gmail.com',
               pass: 'fnvhyqzsnvlqhkwq'
                }
                });
 
			const mailOptions = {

    			from: `"suraj" <surajjunni52@gmail.com>`,
    			to: 'email',  
    			subject: 'Reset Password Request ', 
    			html: `Hello ${user.name},<br><br>
    			&nbsp;&nbsp;&nbsp;&nbsp; Your reset password token is <b>${random}</b>. 
    			If you are viewing this mail from a Android Device click this <a href = "http://motor/${random}">link</a>. 
